...
import { renderUniforms } from "./common";
...
export class Camera {
  ...
  reset(
    ...
    const projection = mat4.perspective(
      ...
      0.1,
      500,
      renderUniforms.projection_matrix,
    ); // TODO : ここの max を変える
    mat4.inverse(projection, renderUniforms.inv_projection_matrix);
    this.recalculateView();
  }
  ...
  recalculateView() {
    ...
    const view = mat4.lookAt(
      ...
      this.target, // target
      [0, 1, 0], // up
      renderUniforms.view_matrix,
    );

    mat4.inverse(view, renderUniforms.inv_view_matrix);
  }
}
